...
Original file is located at
    https://colab.research.google.com/drive/1po6T7EdtReGE0QsfxhJJvIPgciUu-Ehx
...
The main issue that students tend to have with GradeScope has been the file name.  copy_of_Dunkin_1.py won’t work.  Also, Don’s_Dunkin_1.py won’t work.  You should make sure that the file that you upload is called Dunkin_1.py.
...
You will see the expression below uses a global variable called sc_price. This variable is assigned the value of the price of a small coffee in the dunkin_menu. The print function is used to print the cost of a small coffee in the dunkin_menu. It will not in any way modify any existing values or variables.
...
- menu:  An argument that specifies the data container where products are listed. The function retrieves the price of a specified product from this data container.

- product: The name of a product in the dunkin_menu. For example, 'Small Coffee'.
                
*Output*
    
- result: The cost of a product in the dunkin_menu.
...
"""In this code block, we begin by defining a global variable called sc_price, to retrieve the price of a small coffee from the dunkin_menu. Then, we use the print function to print the cost of three, small coffees.
...
- price: An argument that represents the price of a specific product in the dunkin_menu.  

*Output*

- result: The cost of buying three of the specified products.
...
For this exercise, you will fill in the body of the generalized function 'calculate_price' to calculate the cost of a product in the dunkin_menu when the product's price is multipled by any specified value.

*Input*

- price: An argument that represents the cost of a specific product in the dunkin_menu.

- multiplier: The factor used to multiply the price.

*Output*

- result: The cost of buying multiple of the specified product.
...
- menu:  An argument that specifies the data container where products are listed. The function retrieves the prices of all products from this data container.
         
*Output*

Unlike the preceding functions, this function does not return a value.  It just prints the value associated with each item in the dunkin_menu. The expected result string contains the newline character '\n', this is just so that each number will print on a new line.
"""
