# -*- coding: utf-8 -*-
"""Conditionalize.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1e8_3XghL_kwu-zYO5vSbnlUG8CNofV-2
...
def total_prob_evid(prior, conditional, evidence):
    ...
    #
    for i in prior:
      total += prior[i] * conditional[i][evidence]
    #
    # END OF YOUR CODE
    # ------------------
...
def create_conditionalized(prior, conditional, evidence):
    ...
    #
    for i in prior:
      posterior[i] = prior[i] * conditional[i][evidence] / total_prob_evid(prior, conditional, evidence)
...
firefly_prior = {"Good": 0.718, "Bad": 0.141, "Ugly": 0.141}
firefly_conditional = {
    "Good": {"YELLOW": 1, "WHITE": 0},
    "Bad": {"YELLOW": 1, "WHITE": 0},
    "Ugly": {"YELLOW": 0, "WHITE": 1},
